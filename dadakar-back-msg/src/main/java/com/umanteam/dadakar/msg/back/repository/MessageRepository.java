...
public interface MessageRepository extends MongoRepository<Message, String> {
	...
	List<Message> findByHoroGreaterThanEqualAndHoroLessThanEqual(LocalDateTime horoStart, LocalDateTime horoEnd);
	/* find by sender */
	...
	List<Message> findBySenderIdAndHoroGreaterThanEqualAndHoroLessThanEqual(String sid, LocalDateTime horoStart, LocalDateTime horoEnd);
	/* find by receiver */
	...
	List<Message> findByReceiverIdAndHoroGreaterThanEqualAndHoroLessThanEqual(String rid, LocalDateTime horoStart, LocalDateTime horoEnd);	
	...
	List<Message> findBySenderIdAndReceiverIdAndHoroGreaterThanEqualAndHoroLessThanEqual(String sid, String rid, LocalDateTime horoStart, LocalDateTime horoEnd);
}
