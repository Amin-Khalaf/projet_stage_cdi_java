...
<body class="col-xs-12">
		...
		<div class="container-fluid">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/price/index">Spécifier les prix et les taux
							de marge</a></li>
					<li><a href="/admin/index">Gérer les
	...
	<section class="vert-form">
		<h2>Créer / modifier un prix</h2>
		<form:form action="save" method="POST" modelAttribute="runpriceForm" class="form-horizontal" >
			...
			<spring:bind path="power">
			  <div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label">Puissance fiscale du véhicule</label>
				<div class="col-sm-10">
			  ...
			  <div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="startingPrice" type="text" class="form-control"
	                                id="startingPrice" placeholder="StartingPrice" pattern="[0-9]{1,7}.{0,1}[0-9]{0,2}" />
			  ...
			  <div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="minPrice" type="text" class="form-control"
	                                id="minPrice" placeholder="MinPrice" pattern="[0-9]{1,7}.{0,1}[0-9]{0,2}" />
			  ...
			  <div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="maxPrice" type="text" class="form-control"
	                                id="maxPrice" placeholder="MaxPrice" pattern="[0-9]{1,7}.{0,1}[0-9]{0,2}" />
			...
			<spring:bind path="rate">
			  <div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label">Prix maximum</label>
				<div class="col-sm-10">
					<form:input path="rate" type="text" class="form-control"
	                                id="rate" placeholder="Rate" pattern="0.[0-9]{1,3}" />
